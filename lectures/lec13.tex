...
\begin{frame}{Bits and pieces}
  \begin{itemize}
    ...
    \item Dec 17?/18?/\textbf{19}: Project presentations
      \subitem{Will announce precise date, watch email}
...
\begin{frame}{Visualization demo}
  Software links:
  \begin{itemize}
    \item \weblink{https://wci.llnl.gov/codes/silo/}{libsilo} (LLNL ``WCI'', BSD license)
    \item \weblink{https://wci.llnl.gov/codes/visit/}{VisIt} (LLNL ``WCI'', BSD license)
  \end{itemize}
  Alternative:
  \begin{itemize}
    \item \weblink{http://paraview.org}{Paraview} (KitWare/LANL, BSD
      license)
    \item TecPlot (\$\$\$)
  \end{itemize}
\end{frame}
...
% -----------------------------------------------------------------------------
\begin{frame}{General Graphs: Implementations}
  \begin{itemize}
    \item \weblink{http://cilkplus.org/}{Intel Cilk(+)} (also: vector math)
    \item OpenCL (``Events'', Out-of-order queues)
    \item \weblink{http://threadingbuildingblocks.org/}{Intel Thread Building Blocks}
    \item \weblink{http://runtime.bordeaux.inria.fr/StarPU/}{StarPU}
    \item \weblink{http://charm.cs.illinois.edu/}{(Charm++)}
    \item Many more
  \end{itemize}
\end{frame}
% -----------------------------------------------------------------------------
